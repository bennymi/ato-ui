...
<form>
	<div class="flex items-center">
		...
		<button
			{...$root}
			use:root
			class="relative {containerClasses} cursor-default rounded-switch transition-colors {bgClasses} {$switchDisabled
				? 'cursor-not-allowed opacity-70'
				: ''}"
			id={uniqueId}
		>
			<span
				class="flex justify-center items-center {insideClasses} translate-x-0.5 rounded-switch bg-white
