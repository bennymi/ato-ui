<div class="flex flex-col justify-center items-center min-h-screen text-surface-900-50">
	<!-- <div
...
> -->
	<section class="flex flex-col gap-8 justify-center select-none">
		<h1 class="text-gradient-b-primary-secondary-600 text-8xl font-extrabold text-center scale-150">
			A
		</h1>
		...
		<div class="font-bold text-xl">The ato(mic) component library for Svelte</div>
	</section>
	<section>
		<div />
	</section>
